...
# Memory: prog_mem
MEM_0 := prj_processor_prog_mem
$(MEM_0)_NAME := prog_mem
...
$(MEM_0)_HIERARCHICAL_PATH := prog_mem
$(MEM_0)_WIDTH := 32
...
.PHONY: prog_mem
prog_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
