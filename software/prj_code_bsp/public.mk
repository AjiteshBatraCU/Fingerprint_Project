...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../prj_processor.sopcinfo
...
# Design Name 
# setting SOPC_NAME is prj_processor
SOPC_NAME := prj_processor
...
# The SOPC System ID 
# setting SOPC_SYSID is 3545084735
SOPC_SYSID_FLAG += --id=3545084735
ELF_PATCH_FLAG  += --id 3545084735
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1565053868
SOPC_SYSID_FLAG += --timestamp=1565053868
ELF_PATCH_FLAG  += --timestamp 1565053868
