// project_processor_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module project_processor_mm_interconnect_0 (
	...
	wire  [95:0] pwm_control_s1_agent_rf_source_data;                                       // PWM_control_s1_agent:rf_source_data -> PWM_control_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] pwm_control_s1_agent_rsp_fifo_out_data;                                    // PWM_control_s1_agent_rsp_fifo:out_data -> PWM_control_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> PWM_control_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // PWM_control_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [7:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> PWM_control_s1_agent:cp_channel
	...
	wire  [95:0] fp1_control_s1_agent_rf_source_data;                                       // fp1_control_s1_agent:rf_source_data -> fp1_control_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] fp1_control_s1_agent_rsp_fifo_out_data;                                    // fp1_control_s1_agent_rsp_fifo:out_data -> fp1_control_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> fp1_control_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // fp1_control_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> fp1_control_s1_agent:cp_channel
	...
	wire  [95:0] fp2_control_s1_agent_rf_source_data;                                       // fp2_control_s1_agent:rf_source_data -> fp2_control_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] fp2_control_s1_agent_rsp_fifo_out_data;                                    // fp2_control_s1_agent_rsp_fifo:out_data -> fp2_control_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> fp2_control_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // fp2_control_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> fp2_control_s1_agent:cp_channel
	...
	wire  [95:0] prog_mem_s1_agent_rf_source_data;                                          // prog_mem_s1_agent:rf_source_data -> prog_mem_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] prog_mem_s1_agent_rsp_fifo_out_data;                                       // prog_mem_s1_agent_rsp_fifo:out_data -> prog_mem_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> prog_mem_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // prog_mem_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> prog_mem_s1_agent:cp_channel
	...
	wire  [94:0] pwm_control_s1_agent_rp_data;                                              // PWM_control_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [94:0] fp1_control_s1_agent_rp_data;                                              // fp1_control_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [94:0] fp2_control_s1_agent_rp_data;                                              // fp2_control_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [94:0] prog_mem_s1_agent_rp_data;                                                 // prog_mem_s1_agent:rp_data -> router_008:sink_data
	...
	project_processor_mm_interconnect_0_router router (
	...
	project_processor_mm_interconnect_0_router_001 router_001 (
	...
	project_processor_mm_interconnect_0_router_002 router_002 (
	...
	project_processor_mm_interconnect_0_router_002 router_003 (
	...
	project_processor_mm_interconnect_0_router_004 router_004 (
	...
	project_processor_mm_interconnect_0_router_002 router_005 (
	...
	project_processor_mm_interconnect_0_router_002 router_006 (
	...
	project_processor_mm_interconnect_0_router_002 router_007 (
	...
	project_processor_mm_interconnect_0_router_004 router_008 (
	...
	project_processor_mm_interconnect_0_router_002 router_009 (
	...
	project_processor_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                   //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	project_processor_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                                          //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	project_processor_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_cmd_mux_002 cmd_mux_006 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_rsp_demux_002 rsp_demux_006 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	project_processor_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
